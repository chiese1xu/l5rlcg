...
<form action="/tp/index.php/User/Supply/save" method="post" enctype="multipart/form-data">
	hello <?php echo ($user["realname"]); ?> !
...
<tr><td>日期</td><td><input type="date" name="date" placeholder="日期" value="<?php echo ($person["date"]); ?>" ></td></tr>
